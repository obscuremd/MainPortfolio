...
import Research from '../../Components/product/Research';
...
const ProductDescription = () => {
  ...
  const db = getFirestore(app);
    ...
    useEffect(() => {
      const getData = async () => {
          try {
              const datas = await getDocs(collection(db, 'Product design'));
    ...
    <div>
     {/* hero */}
        <Slider 
          ...
          important={'Contact Me'}
          important_link={"mailto:md.erhenede@gmail.com"}/>
        ...
        <div className='px-5 md:px-16 flex flex-col gap-[35px] md:gap-[68.05px]'>
            ...
            <div className='md:grid flex flex-wrap md:grid-cols-2 gap-[24.75px]' >
              ...
              <div className='flex flex-col gap-[24.75px]'>
                ...
                <EmpathyMap title={'Empathy Map'} data={selectedItem.features}/>
              </div>
              {/* col 2 */}
              <div className='flex flex-col gap-[24.75px]'>
                <ColorBox color={selectedItem.color}/>
                <Research 
                  title={'problem'} 
                  text={selectedItem.problem}
                  title2={'solution'}
                  text2={selectedItem.solution}/>
              </div>
